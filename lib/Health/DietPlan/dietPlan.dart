...
class _dietPlanState extends State<dietPlan> {
  ...
  void goVegan() async {
    Navigator.pushReplacementNamed(
      ...
      arguments: DietPlanData(VeganData.TITLE, VeganData.DESC, VeganData.HOWTOUSE, VeganData.image1, VeganData.name1,
          VeganData.image2, VeganData.name2, VeganData.image3, VeganData.name3),
    );
  }
                ...
                child: GestureDetector(
                    ...
                    child: Stack(children: <Widget>[
                      Container(
                        ...
                        padding: EdgeInsets.fromLTRB(DimensionUtils.margin_large, DimensionUtils.margin_small,
                            DimensionUtils.margin_large, DimensionUtils.margin_small),
                        decoration: new BoxDecoration(
                          image: new DecorationImage(
                            image: new AssetImage("images/ic_dietplan.jpg"),
                            fit: BoxFit.cover,
                          ),
                        ),
                        child: Text(
...
//
                                    ...
                                    decoration: new BoxDecoration(
                                      borderRadius: BorderRadius.all(Radius.circular(DimensionUtils.margin_large)),
                                      image: new DecorationImage(
                                        image: new AssetImage("images/ic_cleaneatings.jpg"),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                    child: Text(
                                      ...
                                      child: Stack(children: <Widget>[
                                        Container(
                                          ...
                                          decoration: new BoxDecoration(
                                            ...
                                            image: new DecorationImage(
                                              image: new AssetImage("images/ic_ketogenic.jpg"),
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                          child: Text(
                  ...
                  (widget.bmi > 0.0 && widget.bmi < 25.0)
                                        ...
                                        Container(
                                          ...
                                          decoration: new BoxDecoration(
                                            borderRadius:
                                                BorderRadius.all(Radius.circular(DimensionUtils.margin_large)),
                                            image: new DecorationImage(
                                              image: new AssetImage("images/ic_flexitarian.jpg"),
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                          child: Text(
                      ...
                      : Container(
                          child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                  padding: EdgeInsets.only(left: DimensionUtils.margin_large),
                                  child: GestureDetector(
                                      onTap: () {
                                        Navigator.pushReplacementNamed(
                                          context,
                                        ...
                                        Container(
                                          ...
                                          decoration: new BoxDecoration(
                                            borderRadius:
                                                BorderRadius.all(Radius.circular(DimensionUtils.margin_large)),
                                            image: new DecorationImage(
                                              image: new AssetImage("images/ic_paleo.jpg"),
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                          child: Text(
                                        ...
                                        Container(
                                          ...
                                          decoration: new BoxDecoration(
                                            borderRadius:
                                                BorderRadius.all(Radius.circular(DimensionUtils.margin_large)),
                                            image: new DecorationImage(
                                              image: new AssetImage("images/ic_vegan.jpg"),
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                          child: Text(
...
//!-----------
          ...
          //   child: Text(
          //     "PROTEIN DIETS",
          //     style: style.copyWith(color: ColorUtils.black, fontWeight: FontWeight.bold),
          //   ),
          // ),

          // Row(
          //   crocrossAxisAlignment: CrossAxisAlignment.spaceEvenly,
          ...
          // Row(
          //   crocrossAxisAlignment: CrossAxisAlignment.start,
          //   mainAxisSize: MainAxisSize.max,
          //   children: [
          //     //DropDown Selection View
