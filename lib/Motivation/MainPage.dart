...
class _MainState extends State<MainPage> {
  ...
  getQuote() async {
    try {
      ...
      var response =
      await http.post(Uri.encodeFull('https://api.forismatic.com/api/1.0/'), body: {"method": "getQuote", "format": "json", "lang": "en"});
      setState(() {
        try {
  ...
  shareQuote() async {
    ...
    screenshotController.captureAndSave(path).then((_) {
